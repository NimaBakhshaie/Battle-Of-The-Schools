...
const computer = new SteelComputer({ key: process.env.STEEL_API_KEY, stateFile: process.argv.includes('--fresh') ? `.orbit/tutor-smoke-${randomUUID()}.json` : '.orbit/tutor-smoke-computer.json' });
