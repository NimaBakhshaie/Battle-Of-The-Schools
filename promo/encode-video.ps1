param(
  [string]$Ffmpeg = ".orbit-video-deps/imageio_ffmpeg/binaries/ffmpeg-win-x86_64-v7.1.exe"
)

$ErrorActionPreference = "Stop"
$root = [System.IO.Path]::GetFullPath("artifacts/orbit-promo")
$frames = Join-Path $root "frames/frame-%04d.jpg"
$audioMaster = Join-Path $root "orbit-promo.webm"
$output = Join-Path $root "orbit-promo.mp4"
